...
DATA_ADDRESS_MACROS = {
    "SHELLPP_ABI_STYLE_MISANS_DEMIBOLD_32_ADDR",
    "SHELLPP_ABI_SETTINGS_TEMPLATE_ADDR",
    "SHELLPP_ABI_SETTINGS_LIST_SLOT_ADDR",
    "SHELLPP_ABI_SETTINGS_SECOND_LIST_SLOT_ADDR",
}
